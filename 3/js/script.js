...
/*!********************************!*\
  !*** ./source/js/constants.js ***!
  \********************************/
/*! exports provided: COVERED_PAGES, UNCOVERED_PAGES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COVERED_PAGES", function() { return COVERED_PAGES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UNCOVERED_PAGES", function() { return UNCOVERED_PAGES; });
const COVERED_PAGES = [`#prizes`];
const UNCOVERED_PAGES = [`story`];
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers */ "./source/js/helpers.js");
...
class FullPageScroll {
  ...
  init() {
    ...
    window.addEventListener(`hashchange`, (event) => this.newHash = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getHash"])(event.newURL));
  ...
  changeVisibilityDisplay() {
    ...
    const covered = _constants__WEBPACK_IMPORTED_MODULE_1__["COVERED_PAGES"].includes(hash) && _constants__WEBPACK_IMPORTED_MODULE_1__["UNCOVERED_PAGES"].includes(this.newHash);
...
/* harmony import */ var _modules_app__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/app */ "./source/js/modules/app.js");
// modules
...
fullPageScroll.init();
_modules_app__WEBPACK_IMPORTED_MODULE_9__["default"].init();
